    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Registro Log Add</h3>
            </div>
            <?php echo form_open('registro_log/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="conteudo_anterior" class="form-control" id="conteudo_anterior"><?php echo $this->input->post('conteudo_anterior'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<label for="conteudo_posterior" class="control-label">Conteudo Posterior</label>
						<div class="form-group">
							<textarea name="conteudo_posterior" class="form-control" id="conteudo_posterior"><?php echo $this->input->post('conteudo_posterior'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
